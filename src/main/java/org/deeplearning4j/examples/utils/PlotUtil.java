...
public class PlotUtil {
     ...
     */
    public static void plotTrainingData(MultiLayerNetwork model, DataSet ds, INDArray backgroundIn, int nDivisions) {
     ...
     * @param nDivisions    Number of points (per axis, for the backgroundIn/backgroundOut arrays)
     */
    public static void plotTestData(MultiLayerNetwork model, DataSet ds, INDArray backgroundIn, int nDivisions) {
